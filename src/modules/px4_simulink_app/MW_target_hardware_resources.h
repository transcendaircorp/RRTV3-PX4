...
#define MW_CONNECTIONINFO_XCPONSERIAL_BAUDRATE \
    codertarget.pixhawk.internal.getExternalModeBaudrate(hCS);
#define MW_CONNECTIONINFO_XCPONSERIAL_COMPORT \
    codertarget.pixhawk.internal.getExternalSerialPortName(hCS);
